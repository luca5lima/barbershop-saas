...
- **Instalação do Node.js:** Download e Instalação do node na versão LTS.
...
npm init
```
![Start Projet](./img/2-node-proj.PNG)
...
### 4. Configuração do Git e Script de Execução
